...
NDefines.NAI.CANCEL_COMBAT_DISADVANTAGE_RATIO = 1.0	-- Vanilla 1.5                     -- If the enemy's advantage ratio over us during (normal) combat is more than <value>, allow canceling the attack
...
NDefines.NAI.NUM_FACTORIES_IN_STATE_TO_WANT_ENERGY_REDUCTION = 10			-- How many mils should we want in a state before we think about building energy reduction cap building
NDefines.NAI.TOTAL_STATE_EXTRACTED_RESOURCES_FOR_BUILDING_RESOURCE_CAP_BUILDING = 100.0	--How many resources required for building a resource inproving infra cap building
...
NDefines.NAI.DIVISION_SUPPLY_RATIO_TO_MOTORIZE = 1.0
...
NDefines.NAI.PLAN_EXECUTE_CAREFUL_LIMIT = 6                -- When looking for an attack target, this score limit is required in the battle plan to consider province for attack
...
NDefines.NAI.PLAN_EXECUTE_SUPPLY_CHECK = { 0.6, 0.4, 0.7, 1.0, 0.6 }
...
NDefines.NAI.PLAN_VALUE_TO_EXECUTE = -0.3				-- AI will typically avoid carrying out a plan it below this value (0.0 is considered balanced).
...
NDefines.NAI.AIFC_PATH_COST_TRN_MOUNTAINS = 2.2
NDefines.NAI.AIFC_PATH_COST_TRN_MARSH = 2.2
NDefines.NAI.AIFC_PATH_COST_TRN_PLAINS = 1.00
NDefines.NAI.AIFC_PATH_COST_TRN_FOREST = 1.00
NDefines.NAI.AIFC_PATH_COST_TRN_URBAN = 0.90
...
NDefines.NAI.AIFC_FRESHNESS_BASE_VALUE = 35.0                 --45         -- AIFC fronts have a "freshness value" which decreases if no progress is made. When it reaches zero, it will give up on the current target and try another.
NDefines.NAI.AIFC_REFRESH_NEED_SUPPLY_FACTOR_PER_DAY = 4.0		--.8		-- Decrease freshness value with this multiplied by average supply ratio every day.
NDefines.NAI.AIFC_FRESHNESS_ADD_ON_PROGRESS = 20.0 			--.25	-- Increase freshness value with this when we advance a province along the target path
...
NDefines.NAI.AIFC_CA_DIVISIONS_PER_PROVINCE = 1
NDefines.NAI.AIFC_UNIT_RATIO_BASE = 0.05 --.15 -- After fulfilling minimum front unit needs, this ratio of the "extra"/desired units can be allocated to AI force concentration duty
